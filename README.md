...
This package provides **BingX exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BINGX** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bingx |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bingx/issues |
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bingx/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BingX exchange plugin for bt_api**。它提供了与 **BINGX** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bingx |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bingx/issues) 反馈问题
